package com.github.chen0040.art.rl.minefield.gui;

import com.github.chen0040.art.rl.FalconConfig;
import com.github.chen0040.art.rl.minefield.*;
...
import com.github.chen0040.art.rl.minefield.utils.FileUtils;
...
public class MineFieldSimulatorGUI extends JFrame {
    ...
    public void initialize (MineField maze)
    {
        ...
        p_sense.setLayout(new GridLayout(3, 1, 0, 0));
    ...
    private JPanel createDropdown_AgentSelection(){
        ...
        ddAgentSelection.addItemListener(e -> {
    ...
    private void createMenuBar(){
        ...
        miShowTrack.addActionListener(e -> {
    ...
    private JMenuItem createMenuItem_Mines(final int numMines){
        JRadioButtonMenuItem mi1 = new JRadioButtonMenuItem(String.valueOf(numMines));
    ...
    private JMenuItem createMenuItem_Runs(final int runs){
        JRadioButtonMenuItem mi1 = new JRadioButtonMenuItem(String.valueOf(runs));
    ...
    private JMenuItem createMenuItem_MaxSteps(final int maxSteps){
        JRadioButtonMenuItem mi1 = new JRadioButtonMenuItem(String.valueOf(maxSteps));
    ...
    private JMenu createMenu_MaxTrials(){
        ...
        int[] options = { 1000, 2000, 3000, 4000 };
    ...
    private JMenuItem createMenuItem_MaxTrials(final int maxTrials){
        JRadioButtonMenuItem mi1 = new JRadioButtonMenuItem(String.valueOf(maxTrials));
    ...
    private JMenu createMenu_SimulationTarget(){
        ...
        miMovingTarget.addActionListener(e -> {
            JCheckBoxMenuItem checkButton = (JCheckBoxMenuItem) e.getSource();
    ...
    private JMenu createMenu_Signals(){
        ...
        miIncludeSonar.addActionListener(e -> {
            JCheckBoxMenuItem checkButton = (JCheckBoxMenuItem) e.getSource();
        ...
        miIncludeAVSonar.addActionListener(e -> {
            JCheckBoxMenuItem checkButton = (JCheckBoxMenuItem) e.getSource();
            if (checkButton.isSelected()) {
                simulator.getConfig().numSonarInput = 10;
            } else {
        ...
        miIncludeBearing.addActionListener(e -> {
            JCheckBoxMenuItem checkButton = (JCheckBoxMenuItem) e.getSource();
            if (checkButton.isSelected()) {
        ...
        miIncludeRange.addActionListener(e -> {
            JCheckBoxMenuItem checkButton = (JCheckBoxMenuItem) e.getSource();
            if (checkButton.isSelected()) {
    ...
    private JMenuItem createMenuItem_SimulationAgentNum(final int agentNum){
        JRadioButtonMenuItem mi1 = new JRadioButtonMenuItem(String.valueOf(agentNum));
    ...
    private JMenu createMenu_SimulationInterval(){
        ...
        int[] options = { 10, 20, 50, 100, 200, 300, 400, 500, 600, 700 };
    ...
    private JMenuItem createMenuItem_SimulationInterval(final int interval){
        JRadioButtonMenuItem mi1 = new JRadioButtonMenuItem(String.valueOf(interval));
    ...
    public void runSims(){
        Thread thread = new Thread(() -> simulator.runSims(progress -> {
