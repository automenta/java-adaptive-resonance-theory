...
public abstract class FalconNavAgent {
    ...
    private final int numSonarInput;
    private final int numAVSonarInput;
    private final int numRangeInput;
    private final int numBearingInput;
    ...
    public Set<Integer> getFeasibleActions(MineField maze){
        Set<Integer> feasibleActions = new HashSet<>();
