package com.github.chen0040.art.rl.minefield.env;

import com.github.chen0040.art.rl.minefield.utils.RewardType;
import com.github.chen0040.art.rl.minefield.utils.Vec2I;
...
public class MineField {
    ...
    private static int[][] createSquare(int size, int value) {
    ...
    public static boolean isOutOfField(Vec2I pos) {
    ...
    public double getReward(AutonomousVehicle vehicle, int d, boolean immediate) {
        ...
        return getReward(next_pos, immediate);
    }
    ...
    AutonomousVehicle getAgent(int x, int y) {
        int vehicleId = vehicle_signals[x][y];
        return vehicleId == -1 ? null : vehicles[vehicleId];
    }
    ...
    public void turn(int vehicleId, int b) {
        vehicles[vehicleId].turn(b);
    }

    public boolean isHitMine(int vehicleId) {
        return isHitMine(vehicles[vehicleId]);
    }

    public boolean isHitMine(AutonomousVehicle vehicle) {
        return vehicle.isHitMine() || hasMine(vehicle.getX(), vehicle.getY());
    }
    ...
    public boolean isHitTarget(int vehicleId) {
        AutonomousVehicle vehicle = vehicles[vehicleId];
        return vehicle.isHitTarget() || isHitTarget(vehicle);
    }
    ...
    public int move(int vehicleId, int d) {
        return vehicles[vehicleId].move(this, d);
    }

    public boolean isConflicting(int vehicleId) {
        return vehicles[vehicleId].isConflicting();
    }
