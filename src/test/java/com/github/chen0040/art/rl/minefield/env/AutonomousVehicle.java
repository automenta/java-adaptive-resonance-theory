...
import com.github.chen0040.art.rl.minefield.utils.VehicleState;
...
public class AutonomousVehicle {
    private final Vec2I currentPosition = new Vec2I();
    private final Vec2I prevPosition = new Vec2I();
    private int currentBearing;
    private int prevBearing;
    private VehicleState state;
    private final List<Vec2I> path = new ArrayList<>();
    private int step;
    ...
    public static int adjustBearing(int old_bearing)
    {
    ...
    public double[] getSonar(MineField maze)
    {
        ...
        if(MineField.isOutOfField(this.getCurrentPosition())) {
