...
import com.github.chen0040.art.rl.minefield.utils.SimulatorConfig;
...
public class MineFieldSimulatorConfig extends SimulatorConfig {
    ...
    private boolean immediateRewardProvided; // whether immediate reward is provided in a trial
    private int uiInterval = 500; // interval for each step in ui thread

    public boolean targetMoving;

    public int numSonarInput = 10;
    public int numAVSonarInput;
    public int numBearingInput = 8;
    public int numRangeInput;
    public boolean applyTDFALCON;
