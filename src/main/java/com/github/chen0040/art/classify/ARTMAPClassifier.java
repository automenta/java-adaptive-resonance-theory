...
import com.github.chen0040.art.ResonantMap;
...
public class ARTMAPClassifier<Y> {
    ...
    @Deprecated
    public void put(DataFrame batch) {
    ...
    @Deprecated
    public Y put(DataRow r, boolean can_create_node) {
        double[] x = r.toArray();
        String y = r.categoricalTarget();
