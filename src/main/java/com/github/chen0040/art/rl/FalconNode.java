...
public class FalconNode {
    ...
    public double e; // eligibility trace
    ...
    public static double[] arrayTimes(double[] x, double[] weights) {
        int len = x.length;
    ...
    public static double[] fuzzyAND(double[] x1, double[] x2) {
        int len = x1.length;
    ...
    protected static double fuzzyAND(double x1, double x2) {
    ...
    private static double computeMatchValue(double[] x, double[] weights) {
